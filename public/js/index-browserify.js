...
},{"./tailwind-toast/twtoast.js":6}],3:[function(require,module,exports){
...
},{"../utils/helpers":7,"../utils/options.json":8}],4:[function(require,module,exports){
const h = require('../utils/helpers')
const options = require('../utils/options.json')
const numbers = ['one', 'two', 'three', 'four', 'five', 'six', 'seven', 'eight', 'nine', 'zero', 'ten', 'eleven']
...
},{"../utils/helpers":7,"../utils/options.json":8,"twemoji":1}],5:[function(require,module,exports){
{
  //default values
  modules: [
    //custom modules
...
},{"./classes/Snackbar":3,"./classes/Toast":4,"./twtoast.config.js":5}],7:[function(require,module,exports){
